                    ...
                    <TableCell key={index}>
                      {header.key === 'phoneNumbers' ? (
                        <Box>
                          ...
                          <Chip 
                            label={Array.isArray(row.phoneNumbers) ? row.phoneNumbers[0] : (row.phoneNumbers || 'N/A')} 
                            variant="outlined" 
                            size="small"
                            sx={{ mr: 1 }} 
                          />
                          ...
                          {Array.isArray(row.phoneNumbers) && row.phoneNumbers.length > 1 && (
                            <Tooltip title={row.phoneNumbers.slice(1).join(', ')} arrow>
                              <Chip label={`+${row.phoneNumbers.length - 1} more`} color="primary" variant="outlined" size="small" />
                            </Tooltip>
                          )}
                        </Box>
                      ) : header.key === 'pay' ? (
